		...
		\subsubsection{Results}
		  ...
		  \paragraph{County Model}
		    ...
		    \begin{table}[H]
		      ...
		      % \small
		      \caption{County Model}
		      \input{../../output/tables/Exploration/nlreg_rand_County}
		    \end{table}
		  ...
		  \paragraph{Judge Model}
		    ...
		    \begin{table}[H]
		      ...
		      \small
		      \caption{Judge Model}
		      \input{../../output/tables/Exploration/nlreg_rand_JudgeID}
		    \end{table}
